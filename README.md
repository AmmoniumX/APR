...
See `default_config.yaml` for an example configuration.

To install the package `hellocpp-git` using said configuration:

```bash
apri -c ./default_config.yaml -Syu hellocpp-git
```

Also see `apri --help` for more information
